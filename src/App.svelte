<script>
  // vim has insert and normal
  // vim sudoku can have two modes as well
  // insert will add the number as the final answer
  // normal will add pencil marks
